...
export function encodeTypedDataMessage(msg) {
...
export function hashTypedDataMessage(msg) {
...
export function recoverMessageSignature(sig, msg) {
  const hash = hashMessage(msg);
  const signer = recoverAddress(sig, hash);
  return signer;
}

export function recoverTypedMessage(sig, msg) {
